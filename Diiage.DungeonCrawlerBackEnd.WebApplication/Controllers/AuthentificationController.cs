...
namespace Diiage.DungeonCrawlerBackEnd.WebApplication.Controllers
{
    public class AuthentificationController : Controller
    {
        ...
        public IActionResult Exchange(OpenIdConnectRequest connectionRequest)
        {
            if (connectionRequest.IsPasswordGrantType())
            {
                ...
                if (connectionRequest.Username != "alice@wonderland.com" ||
                    connectionRequest.Password != "P@ssw0rd")
                {
